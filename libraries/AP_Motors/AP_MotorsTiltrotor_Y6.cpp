...
void AP_MotorsTiltrotor_Y6::output_armed()
{
    ...
    hal.rcout->write(0, _servo1.radio_out);
    hal.rcout->write(1, _servo1.radio_out);
    hal.rcout->write(2, _servo1.radio_out);
    hal.rcout->write(3, _servo1.radio_out);
    hal.rcout->write(4, _servo1.radio_out);
    hal.rcout->write(5, _servo1.radio_out);
    hal.rcout->write(6, _servo1.radio_out);
    hal.rcout->write(7, _servo1.radio_out);
    hal.rcout->write(8, _servo1.radio_out);
    hal.rcout->write(9, _servo1.radio_out);
    hal.rcout->write(10, _servo1.radio_out);
    hal.rcout->write(11, _servo1.radio_out);
    hal.rcout->write(12, _servo1.radio_out);
}
